  ...
  return (
    <div className="urm-editor">
      ...
      <Form colon={false}>
        ...
        <div className="row">
          <div>
            <Button icon="file-excel" onClick={method.addByExcel} disabled={fields.length > 0} />
            <Button icon="database" onClick={method.addByQuery} disabled={fields.length > 0} />
            <Button icon="copy" onClick={method.copyData} disabled={fields.length > 0} />
          </div>
          <div className="flex-right">
            <Button icon="plus-square" onClick={method.clickAppend} />
            <Button icon="minus-square" onClick={method.clickRemove} />
          </div>
        </div>
