    ...
    search: (param) => {
      ...
      urmsc.ajax({
        ...
        success: function(list) {
          _this.setState({items: list, fields: []})
        },
      })
    },
    ...
    viewFields: (record) => {
      ...
      urmsc.ajax({
        ...
        success: function(fields) {
          _this.setState({fields: (fields ? fields : [])})
        }
      })
    }
  }
  ...
  render() {
    return (
      <div className="urm-list">
        <WrappedCopySearch  {...this.props} search={this.method.search} wrappedComponentRef={ref => { if (ref) this.searchForm = ref.props.form }} />
        <Table className="table-striped"
          ...
          <Table.Column title={locale['label.registId']} dataIndex="regId" ellipsis />
        ...
        <Table className="table-striped"
          ...
          <Table.Column title={locale['label.fieldName']} dataIndex="engName" ellipsis />
          <Table.Column title={locale['label.fieldLocalName']} dataIndex="name" ellipsis />
          <Table.Column title={locale['label.fieldType']} dataIndex="type" width="85px" render={(val) => ( this.method.getFieldStr('type', val) )}/>
          <Table.Column title={locale['label.dFormat']} dataIndex="dateFormat" ellipsis />
          <Table.Column title={locale['label.len']} dataIndex="length" width="70px" />
